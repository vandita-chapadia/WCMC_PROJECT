...
class SSignUp extends StatefulWidget {
  @override
  _SSignUpState createState() => _SSignUpState();
}
                    ...
                    children: <Widget>[
                      Positioned(
                        child: FadeAnimation(1.6, Container(
                          ...
                          child: Center(
                            child: Text("Student SignUp", style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),),
                          ),
                        )),
                      )
                    ],
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                    validator: (input) {
                                      if (input.isEmpty) return 'Enter Charusat Email';
